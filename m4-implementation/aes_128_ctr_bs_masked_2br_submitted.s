...
generate_random:
    ...
    str.w r0, [sp, #156] //must store, don't want to destroy original p.rk
    ...
    //Result before manual finetuning: 103 loads and 75 stores
    ...
    //[('r0', 'o6'), ('r1', 'o1'), ('r2', 'o3'), ('r3', 'o2'), ('r4', 'o5'), ('r5', 'o7'), ('r6', 'L22_0'), ('r7', 'o4'), ('r8', 'o0'), ('r9', 'L3_0'), ('r10', 'L29_0'), ('r11', 'L17_0'), ('r12', 'L19_0'), ('r14', 'XM53_06')]
    ...
    eor r4, r1, r4, ror #8 //mo7
    eor r5, r2, r5, ror #8 //mo6
    eor r4, r3       //o7
    eor r5, r3       //o6
    ...
    eor r10, r1, r10, ror #8
    eor r11, r2, r11, ror #8
    eor r10, r14
    eor r11, r3
    ...
    eor r0, r0, r14, lsl #8
    ubfx r14, r7, #8, #6
    eor r0, r0, r14, lsl #10
    ubfx r14, r7, #20, #4
    eor r0, r0, r14, lsl #16
    ubfx r14, r7, #16, #4
    eor r0, r0, r14, lsl #20
    ubfx r14, r7, #26, #6
    eor r0, r0, r14, lsl #24
    ubfx r14, r7, #24, #2
    eor r7, r0, r14, lsl #30
